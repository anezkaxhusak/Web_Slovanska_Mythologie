...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark  ">
    ...
    <main class="article">
      ...
      <section>
        <p><h2>Hromnice</h2>
<p>Oslava příchodu jara, spojená s prvním jarním dnem. Lidé věřili v očistnou moc ohně a světla, které symbolizovaly vítězství nad temnotou a zimou.</p>
...
<p>Oslava boha Jarila, symbolizujícího jaro a plodnost. Slavnosti zahrnovaly tance, zpěv a obřady zaměřené na podporu úrody.</p></p>
      </section>
        </div>
        </div>
    </main>
